...
type Animal = {
    name: 'redPanda' | 'cat' | 'dog' | 'aardvark' | 'snake';
    index: number;
    value: string; 
}

const Picker = ({ items, label }: { items: Animal[]; label: string; }) => {

   

    let items: Animal[] = [
       { id: 'redPanda', index: 0, value: 'Red Panda' },
       { id: 'cat', index: 1, value: 'Cat' },
       { id: 'dog', index: 2, value: 'Dog' },
       { id: 'aardvark', index: 3, value: 'Aardvark' },
       { id: 'snake', index: 4, value: 'Snake' }
    ];
