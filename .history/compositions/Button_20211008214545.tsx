import { RefObject, ElementType, HTMLAttributes } from 'react' 
...
export function Button<T extends ElementType = 'button'>(props: AriaButtonProps<ElementType>, ref: FocusableRef<HTMLButtonElement>) {
