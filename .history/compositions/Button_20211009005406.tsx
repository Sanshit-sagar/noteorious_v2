...
export const Button = React.forwardRef(AriaButton) as <T extends ElementType = 'button'
>(props: AriaButtonProps<T> & { ref?: FocusableRef<HTMLElement>) => React.ReactElement
