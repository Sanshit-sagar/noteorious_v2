...
import { useComboBoxState, useSearchFieldState, ComboBoxState } from 'react-stately'
...
export function SearchBar<T extends object>(props: ComboBoxProps<T> & { state: ComboBoxState<T>; contains: (string: string; substring: string) => boolean;  }) {
        ...
        <Container>
            ...
            <InputGroup>
                ...
                <IconButton 
                    ...
                    {...buttonProps} 
                    ref={clearButtonRef}
                    css={{ borderColor: 'transparent', '&:hover':{ borderColor: '$panel' }}}
                >
