...
const AtomicButtonProps = typeof AriaButtonProps<T> & { ref?:typeof FocusableRef<HTMLElement> });

const Button = React.forwardRef(AriaButton) as <T extends ElementType = 'button'>(props: typeof AtomicButtonProps) => React.ReactElement
