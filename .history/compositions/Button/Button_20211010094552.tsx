...
const AtomicButtonProps = AriaButtonProps<T> & { ref?: FocusableRef<HTMLElement> }

export const Button = React.forwardRef(AriaButton) as <T extends ElementType = 'button'>(props: AtomicButtonProps) => React.ReactElement
