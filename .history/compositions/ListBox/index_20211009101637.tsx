...
const InteractiveListItem = ({ isFocused = false, isSelected = false, children }: ListItemPrimitiveProps) => {
    return (
...
>(({ children, ...props }, forwardedRef) => ( 
    <ListItem {...props} ref={forwardedRef}>
        <Box as="span" css={{ position: 'absolute', left: '$1' }}>
            <Flex css={{ width: '$3', height: '$3', alignItems: 'center', justifyContent: 'center', borderRadius: '$2', backgroundColor: '$accent',}}>
                <CheckIcon />  
            </Flex>
        </Box>
        {children} 
