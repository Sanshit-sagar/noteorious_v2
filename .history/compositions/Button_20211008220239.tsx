...
function AriaButton<T extends ElementType = 'button'>(props: AriaButtonProps<ElementType>, ref: FocusableRef<HTMLButtonElement>) {
    ...
    return (
        <FocusRing 
            focusRingClass={classNames(styles, 'focus-ring')} autoFocus={autoFocus}>
            <StyledButton 
...
export const Button = React.forwardRef(AriaButton) as <T extends ElementType = 'button'>(props: AriaButtonProps<T> & { 
