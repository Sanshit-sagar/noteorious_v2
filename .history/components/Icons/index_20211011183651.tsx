...
export const AlignLeftIcon = ({ color = 'rgba(0,0,0,1)' }: { color?: string }) => (<>
    <path fill="none" d="M0 0h24v24H0z"/>
    <path d="M3 4h18v2H3V4zm0 15h14v2H3v-2zm0-5h18v2H3v-2zm0-5h14v2H3V9z" fill={color} />
</>);

export const AlignRightIcon =  ({ color = 'rgba(0,0,0,1)' }: { color?: string }) => (<>
       <path fill="none" d="M0 0h24v24H0z"/>
       <path d="M3 4h18v2H3V4zm2 15h14v2H5v-2zm-2-5h18v2H3v-2zm2-5h14v2H5V9z" fill={color} />
</>);

export const AlignCenterIcon = ({ color = 'rgba(0,0,0,1)' }: { color?: string }) => (<>
    <path fill="none" d="M0 0h24v24H0z"/>
    <path d="M3 4h18v2H3V4zm4 15h14v2H7v-2zm-4-5h18v2H3v-2zm4-5h14v2H7V9z" fill={color} />
</>);

export const AlignJustifyIcon =({ color = 'rgba(0,0,0,1)' }: { color?: string }) => (<>
    <path fill="none" d="M0 0h24v24H0z"/>
    <path d="M3 4h18v2H3V4zm0 15h18v2H3v-2zm0-5h18v2H3v-2zm0-5h18v2H3V9z" fill={color} />
</>);


export const alignmentIcons: IconMapping[] = [
    { name: 'alignLeft', icon: <AlignLeftIcon />, alignment: 'left' },
    { name: 'alignRight', icon: <AlignRightIcon />, alignment: 'left' },
    { name: 'alignCenter', icon: <AlignCenterIcon />,alignment: 'left' },
    { name: 'alignJustify', icon: <AlignJustifyIcon />, alignment: 'left' }
]