...
let alignmentIcons = [
    { name: 'alignJustify', icon:'alignLeft': <AlignLeftIcon />,
    { name: 'alignJustify', icon:'alignRight': <AlignRightIcon />,
    { name: 'alignJustify', icon:'alignCenter': <AlignCenterIcon />,
    { name: 'alignJustify', icon: <AlignJustifyIcon />}
]

const AlignmentIcons = () => {
    <>
        {alignmentIcons.map((alignmentIcon: Element | React.ReactNode, index: number) => {
            <IconWrapper
                key={index} 
                height={'18'} 
                width={'18'} 
