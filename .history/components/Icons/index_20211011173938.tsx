...
export const AlignmentIcons = () => (
    <div style={{ border: 'thin solid black', width: '100%', display: 'flex', flexDirection: 'row', justifyContent: 'flex-start', alignItems: 'center'}}> {alignmentIcons.map((item: IconPair, index: number) => {
        <IconWrapper
            key={index} 
            height={'18'} 
            width={'18'} 
