...
export function ComboBox<T extends object>(props: ComboBoxProps<T>) {
    ...
    let buttonRef: RefObject<HTMLButtonElement> = useRef<HTMLButtonElement | undefined>(null)
    let inputRef: RefObject<HTMLInputElement> = useRef<HTMLInputElement | undefined>(null)
    let listBoxRef: RefObject<HTMLUListElement> = useRef<HTMLUListElement | undefined>(null)
    let popoverRef: RefObject<HTMLDivElement> = useRef<HTMLUListElement | undefined>(null)
