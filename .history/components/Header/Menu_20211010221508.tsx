...
export function ComboBox<T extends object>(props: ComboBoxProps<T>) {
    ...
    return (
        <Container>
            ...
            <ExtendedInputGroup {...buttonProps} buttonRef={buttonRef} inputRef={inputRef} {...inputProps}   <UserInput {...inputProps} ref={inputRef} />
                <PopoverToggler {...buttonProps} ref={buttonRef}>
