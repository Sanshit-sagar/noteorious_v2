...
import { MenuBarItem as Button, AlignmentHandlers } from './MenuBarItem'
...
export const MenuBar = ({ editor }: MenuBarProps) => {
    ...
    const items: IMenuBarItem[] = editor ? [
        ...
        },
        {
            icon: <AlignLeftIcon />,
            title: 'Align Left',
            action: () => editor.chain().focus().clearNodes().setTextAlign('left').run(),
            isActive: () => editor.isActive({ textAlign: 'left' }),
            isDisabled: () => editor.can().setTextAlign('left'),
        },
        {
            icon: <AlignRighttIcon />,
            title: 'Align Right',
            action: () => editor.chain().focus().clearNodes().setTextAlign('right').run(),
            isActive: () => editor.isActive({ textAlign: 'right' }),
            isDisabled: () => editor.can().setTextAlign('right'),
        },
        {
            icon: <AlignCenterIcon />,
            title: 'Align Center',
            action: () => editor.chain().focus().clearNodes().setTextAlign('center').run(),
            isActive: () => editor.isActive({ textAlign: 'center' }),
            isDisabled: () => editor.can().setTextAlign('center'),
        },
        {
            icon: <AlignJustifyIcon />,
            title: 'Align Justify',
            action: () => editor.chain().focus().clearNodes().setTextAlign('justify').run(),
            isActive: () => editor.isActive({ textAlign: 'justify' }),
            isDisabled: () => editor.can().setTextAlign('justify'),
        },
        {
            icon: <EraserIcon />,
            title: 'Clear Format',
    ...
    return (
        <StyledHeader>
            ...
            <AlignmentHandlers editor={editor} /> 
