...
type CustomTreeNode = { name: string; items: { name: string; items: {name: string}[]
...
export const TypeSelector = () => {
    let tree = useTreeData({
        ...
        getKey: (item: TreeNode<{ name: Key; items: { name: Key; }[]; }>) => item.name,
        getChildren: (item: TreeNode<CustomTreeNode>) => item.items
    });
