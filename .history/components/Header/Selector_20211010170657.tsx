...
function initHeadingStylePicker(): HeadingStyle[] {
    return [
        ...
        {name: 'Heading2', icon: <Heading2Icon />, action: () => alert(`Clicked H1`)},
        {name: 'Heading3', icon: <Heading3Icon />, action: () => alert(`Clicked H1`)},
        {name: 'Heading4', icon: <Heading4Icon />, action: () => alert(`Clicked H1`)},
        {name: 'Heading5', icon: <Heading4Icon />, action: () => alert(`Clicked H1`)},
        {name: 'Heading6', icon: <Heading4Icon />, action: () => alert(`Clicked H1`)}
    ];
}
