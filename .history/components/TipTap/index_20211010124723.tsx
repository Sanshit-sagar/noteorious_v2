...
const CommandsList = ({ items, props }: CommandsListProps) => {
    const [selectedIndex, setSelectedIndex] = useState<number>(0) 
    const itemsLength = usePrevious(items.length)
    ...
    const selectItem = (index: number) => (index && index < items?.length) ? setSelectedIndex(index) : null
