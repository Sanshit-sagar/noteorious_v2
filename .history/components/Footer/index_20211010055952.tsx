...
const UserAccountInfo = ({ user, handleUsername }: UserCredentials) => (
    <Button
...
export const Footer = ({ editor, user, handleUsername }: FooterProps) => (
    <>
        <FooterTopBorder /> 
        <StyledFooter> 
           { editor && (
           ...
           <UserAccountInfo user={user} update={handleUsername} /> 
        </StyledFooter> 
    </>
);
