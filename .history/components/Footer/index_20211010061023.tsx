...
const UserCount = ({ status, userCount, roomId }: {  status: string; userCount: number; roomId: string; }) => (
    <>
     {status === 'connected'
...
const UserAccountInfo = ({ user, setName }: { user: UserCredentials; setName: () => void; }) => (
