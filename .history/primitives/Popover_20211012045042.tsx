...
>((contentProps, forwardedRef) => {
    let { sideOffset, children, ...props } = contentProps
    return (
        <StyledContent 
            {...props}  
            ref={forwardedRef}
...
const ExtendedTrigger = React.forwardRef<
    React.ElementRef<typeof StyledTrigger>,
    Radix.ComponentPropsWithoutRef<typeof StyledTrigger>
>((props, forwardedRef) => (
...
export const PopoverContent = ({ children, hideArrow = false }: { children: React.ReactNode; hideArrow?: boolean }) => (
    <ExtendedContent sideOffset={2}>
...
export const PopoverTrigger = (props: any) => <ExtendedTrigger {...props} />;
