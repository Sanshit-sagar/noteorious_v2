...
import { PressEvents, FocusableProps } from '../../types/shared/interaction'
import { FocusableDOMProps, AriaLabelingProps } from "../../types/shared/aria";
...
export interface ToggleButtonProps<T extends ElementType='button'> extends AtomicButtonProps,LinkButtonProps<T>,AriaButtonElementTypeProps<T> {
